...
//
// This code is based on https://github.com/WebFreak001/code-debug/blob/f204573fae2f9614aba4be3307984c28576f3b8d/src/backend/mi_parse.ts
...
export function parseMI(output: string): MINode {
  ...
  let resultRecords:
    | { resultClass: string; results: [string, any][] }
    | undefined = undefined;
